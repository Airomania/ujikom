...
<head>
  ...
  <title>Admin Perpustakaan Login</title>
...
<body class="hold-transition login-page" style="background-image:url(https://statik.tempo.co/data/2020/06/11/id_944597/944597_720.jpg)">">
<div class="login-box">
  <div class="login-logo">
    <a href="#"><h1>Admin Perpustakaan</h1></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
